...
function webhookEvent() {
     ...
     * @param {String} raw body of request
     * @param {String} webhook id
     * @param {String} config http configuration (i.e. client id / secret)
     * @param {Function} callback function
     */
    function verify2(headers, body, webhookId, config, callback) {
        ...
        api.executeHttp('POST', '/v1/notifications/verify-webhook-signature', payload, config, callback);
    }
